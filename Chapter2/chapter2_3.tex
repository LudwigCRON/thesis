...
A first analysis of the chart allows the design of a converter with the desired speed and fidelity of the signal representation in one of the following topology:
\begin{itemize}
    \item[--] Algorithmic
    \item[--] Pipelined
    \item[--] SAR
...
\subsection{Folding}                           % section 2.1
...
\clearpage
\subsection{High Temperature Converters}     % section 2.6
...
The table~\ref{table:algo_comparison_table} compares performance of these converters. 
...
\input{Chapter5/valid_adc}

\section{ADC Comparison: Figure of Merit}
\label{sec:fom}
\input{Chapter2/fom}
...
\subsection{\(g_m/I_{D} \) insight over temperature} % section 2.8
