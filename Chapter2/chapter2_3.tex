...
The flat band voltage depends on the dopant concentration of the substrate, of the gate, and the intrinsic carrier concentration of the silicon. The fermi energy also change over temperature as represented in \figurename~\ref{fig:electron_fermi_si}.
...
Based on the Shockley equation, the forward and reverse current of the diode is defined by equation~(\ref{eqn:shockley-diode-leakage}) where $L_n (L_p)$ represente the equivalent height of the n-block (p-block), while $D_n (D_p)$ is the diffusion coefficients of this block, and $n_i$ is the intrinsic carrier concentation.
\begin{equation}
