...
\begin{center}
    \centering
    \captionof{table}{Spécification du convertisseur analogique-numérique}
...
\begin{center}
    ...
    \captionof{figure}{Compromis de conception analogique en fonction de la largeur du canal des transistors et de leur niveau d'inversion}
...
\begin{center}
    ...
    \begin{minipage}[b]{\textwidth}
        ...
        b) amélioration
    \end{minipage}
	\captionof{figure}{Architecture hybride en trois étages et son amélioration pour ajouter un bit supplémentaire en minimisant la surface estime en utilisant les derniers bits d'un convertisseur algorithmique comme premiers bits d'un sar a redistribution de charge}
...
\begin{center}
    ...
    \begin{minipage}[b]{0.33\textwidth}
        ...
        f) consommation
    \end{minipage}
    \captionof{figure}{Comparateurs conçu pour la température}
\end{center}
...
\begin{center}
    ...
    \captionof{figure}{Dessin de l'OTA conçu de dimension \(52 \mu m \times 128 \mu m\) avec une double pair differentielle interdigitee et common-centroid}
    \label{fig:ota-fr}
\end{center}
...
\begin{center}
    ...
    \begin{minipage}[b]{0.30\linewidth}
        ...
        c) Mesures
    \end{minipage}
    \captionof{figure}{auto-oscillateur asynchrone pour la mesure différentielle du délai avec une résolution de 60 ps}
...
\begin{center}
    ...
    \begin{minipage}[b]{0.49\linewidth}
        ...
        b) Schreier
    \end{minipage}
    \captionof{figure}{Comparaison du convertisseur (grand point rouge) a ceux publiees dans ISSCC et VLSI}
	\label{fig:fom-fr}
\end{center}
