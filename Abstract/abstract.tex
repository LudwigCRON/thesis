...
\begin{center}
    ...
    \begin{minipage}[b]{\textwidth}
        ...
        b) amélioration
    \end{minipage}
	\caption[]{Architecture hybride en trois étages et son amélioration pour ajouter un bit supplémentaire en minimisant la surface estime en utilisant les derniers bits d'un convertisseur algorithmique comme premiers bits d'un sar a redistribution de charge}
