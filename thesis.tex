...
% cSpell:disable
\documentclass[a4paper,fourier,11pt,print,custombib]{./Classes/PhDThesisPSnPDF}
...
\ifdefineChapter
 \includeonly{Chapter2/chapter2_3}
\fi
...
\include{Chapter1/chapter1}  % Intro & Motivation
\include{Chapter2/chapter2_3}% Challenges in conventional ADC
%\include{Chapter2/chapter2}  % Analogue Over Temp
\include{Chapter4/chapter4}  % ADC Topology
\include{Chapter7/chapter7}  % Analogue Building Bloc
\include{Chapter5/chapter5b} % Test and Packaging
