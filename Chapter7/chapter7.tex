...
\begin{figure}[htp]
    ...
    \end{subfigure}
    \caption{Extraction of comparators' characteristics in spice simulation for fast Monte-Carlo Analysis of simulations}
