...
\begin{align}
	...
	V_{\rm op}[3] &= \frac{C_F\left(1+\frac{1}{A}\right) + C_{S2}}{C_F\left(1+\frac{C_F+C_{S2}}{AC_F} \right)} V_{\rm op}[2] - \frac{C_{S2}}{C_F\left(1+\frac{C_F+C_{S2}}{AC_F} \right)} V_{\rm ref}[3] + \frac{C_{S1}}{C_F\left(1+\frac{C_F+C_{S2}}{AC_F} \right)} V_{\rm cm}
